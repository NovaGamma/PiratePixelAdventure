...
def SaveOption(ScreenOpt,ControlOpt):
...
ScreenOpt={}
ScreenOpt['screenX']=1400
ScreenOpt['screenY']=700
Options=Init()
ScreenOpt=Options[0]
...
pygame.display.set_caption("Get it off my chest")
...
button_control=text_button(256,128,screenx//2-128,screeny//2+128,'CONTROLS',20,128//3+20,(255,233,0))
button_control_left=control_button(128,64,128,20,'left',0,0,(255,233,0))
button_control_jump=control_button(128,64,128,2*20+64,'jump',0,0,(255,233,0))
button_control_right=control_button(128,64,128,3*20+2*64,'right',0,0,(255,233,0))
button_control_down=control_button(128,64,128,4*20+3*64,'down',0,0,(255,233,0))
button_control_shoot=control_button(128,64,128,5*20+4*64,'shoot',0,0,(255,233,0))
    ...
    while not start:
        ...
        if button_control.collide(pygame.mouse.get_pos()[0],pygame.mouse.get_pos()[1]):
            if pygame.mouse.get_pressed()[0]:
                ...
                start=True
        elif screenx//2-128<=pygame.mouse.get_pos()[0]<=screenx//2+128 and screeny//2-64<pygame.mouse.get_pos()[1]<screeny//2+64:
            if pygame.mouse.get_pressed()[0]:
                load_lvl1()
                pygame.mixer.stop()
                buttonsound.play()
