...
class language_button(button):
    def __init__(self,width,height,x,y,text,image,color_text=None,name=None):
        self.rect=pygame.Surface((width,height))
        self.rect.fill((179, 179, 179))
        self.rect.set_alpha(180)
        self.name = text if name==None else name
...
enemies.append(player(300,screeny//2,128,96,1,3,'axe'))
...
french_button=language_button(256,128,screenx//2-512,screeny//2-150,'Français',pygame.image.load('Graphism/drapeaux_fr2.PNG'),None,"French")
english_button=language_button(256,128,screenx//2-512,screeny//2,'English',pygame.image.load('Graphism/drapeaux_en2.PNG'))
