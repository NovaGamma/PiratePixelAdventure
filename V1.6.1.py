...
class text_button(button):#defining the text button class, a button that will use text
    def __init__(self,width,height,x,y,text,posX=None,posY=None,color=None):#posX and posY the position of the text in the button
...
class image_button(button):#here it is the image button, working almost as the text button but with an image instead
