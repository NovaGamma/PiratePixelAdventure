...
pygame.display.set_caption("BOAT FIGHT") #name of the window
...
screenx,screeny=1400,700 #size of the window
...
boat1=pygame.image.load('Graphism/boat_phase/434x280enemy_boat.png').convert_alpha()
boat1_damaged=pygame.image.load('Graphism/boat_phase/434x280enemy_boat_damaged.png').convert_alpha()
