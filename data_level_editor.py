...
ennemy_texture=pygame.transform.scale(pygame.image.load('Graphism/level_editor/Captain_normal.png'),(2*64,2*64))
ennemy_texture2=pygame.transform.scale(pygame.image.load('Graphism/level_editor/Captain_invisible.png'),(2*64,2*64))
