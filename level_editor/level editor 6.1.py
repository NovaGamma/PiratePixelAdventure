...
class text_button(button):
    def __init__(self,width,height,x,y,text,color=None,posX=None,posY=None):#posX and posY are in function of the pos of the button
...
def save():
    print("please give the name of the level that you created (don't put spaces in the name) :")
    name=input()
